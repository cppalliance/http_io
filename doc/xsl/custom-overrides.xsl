<xsl:stylesheet version="3.0"
  ...
  <xsl:variable name="doc-ref" select="'http_io.ref'"/>
  <xsl:variable name="doc-ns" select="'boost::http_io'"/>
  ...
  <xsl:template mode="convenience-header" match="@file[contains(., 'boost/http_io')]">http_io.hpp</xsl:template>
